...
Modified by Richard Everson for use in Exeter, 2011, 2012.
"""
...
class TurtleWorld(World):
    ...
    def __init__(self, size=(800, 800), interactive=False):
        World.__init__(self)
    ...
    def setup(self, size=(800, 800)):
        """Create the GUI.

        The tuple size specifies the size of the canvas. Default (800, 800)"""

        # canvas width and height
        self.ca_width = size[0]
        self.ca_height = size[1]
...
class Turtle(Animal):
    ...
    Attributes:
        ...
        width: linewidth
        show: boolean, whether to actually draw the turtle
    """
    def __init__(self, world=None):
        ...
        self.pen_color = 'blue'
        self.width = 1
        self.show = True                # Show the animals
        self.draw()
    ...
    def where(self):
        """Return a (x, y) tuple of the current location"""
    ...
    def fd(self, dist=1):
        ...
        if self.pen:
            self.world.canvas.line([p1, p2], fill=self.pen_color, width=self.width)
        self.redraw()

    def goto(self, x, y, heading=0):
        """Move the turtle to the location (x, y) and set the heading"""
        herex, herey = self.x, self.y
        p1 = [herex, herey]
        p2 = [x, y]
        self.x, self.y = x, y
    ...
    def set_width(self, width):
        """Change the line width drawn by the turtle"""
        self.width = width
...
set_width = Turtle.set_width
goto = Turtle.goto
where_x = Turtle.get_x
where_y = Turtle.get_y
where = Turtle.where
heading = Turtle.get_heading
get_heading = Turtle.get_heading
